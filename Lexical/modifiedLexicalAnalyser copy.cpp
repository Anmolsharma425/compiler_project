...
int main()
{
    ifstream inputFile("input1.txt");  // Open the file
    if (!inputFile) {
    ...
    stringstream buffer;
    buffer << inputFile.rdbuf();  // Read entire file content into buffer
    string sourceCode = buffer.str();  // Store it as a string
